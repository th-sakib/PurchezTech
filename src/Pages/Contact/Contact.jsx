...
const Contact = () => {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Contact PurchezTech, your ultimate destination for the latest tech gadgets and accessories. Shop smart with unbeatable deals, fast shipping, and top-notch customer support. Upgrade your tech game today!"
      />
      <link rel="canonical" href="https://purcheztech.onrender.com/contact" />
      <title>Contact Us | PurchezTech</title>
      {/* meta tag end  */}
          ...
          <div className="w-full lg:w-[45%] px-6 mb-8 lg:mb-0 ">
            ...
            <div className="collapse collapse-plus mb-2 bg-base-200 rounded-sm">
              ...
              <div className="collapse-content">
                <p className="text-sm">
                  Purchez Tech is a leading e-commerce platform that offers a
                  wide range of technology products, including laptops,
                  smartphones, gadgets, accessories, and more.
                </p>
              </div>
            </div>
            <div className="collapse collapse-plus mb-2 bg-base-200 rounded-sm">
              ...
              <div className="collapse-content">
                <p className="text-sm">
                  Purchez Tech operates online and serves customers globally.
                  For specific details about our offices or shipping warehouses,
                  contact us
                </p>
              </div>
            </div>
            <div className="collapse collapse-plus bg-base-200 rounded-sm">
              ...
              <div className="collapse-content">
                <p className="text-sm">
                  Orders can be modified or canceled anytime them. After
                  shipping, the order is processed for shipping and cannot be
                  changed.
                </p>
              </div>
            </div>
